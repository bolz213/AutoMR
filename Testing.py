...
def main():
    ...
    for func_index in func_indices:
            ...
            for MRs_type in MRs_types:
                ...
                if MRs_type.startswith(f"{func_index}_") and MRs_type.endswith(".npz"):
                    ...
                    for index_candidate in range(all_count):
                        ...
                        survive_cost_o = Phase2_Filter.get_cost_of_AB(ProgramToInfer.program, func_index, A, B, i0_all,
                                                                      mode_input_relation,
                                                                      mode_output_relation, degree_of_input_relation,
                                                                      degree_of_output_relation,
                                                                      no_of_elements_output)
                        ...
                        if survive_cost_o < 0.05:
                            ...
                            if survive_cost >= 0.05:
                                isKill = 1
                                break
                    filer_phase2_df.loc[f"{func_index}_{parameters}", "filter_phase2"] = filer_phase2
        ...
        stats.to_csv(f"{MRs_path}/{func_index}_phase2_mutants.csv")
    filer_phase2_df.to_csv(f"{MRs_path}/filter_phase2.csv")
